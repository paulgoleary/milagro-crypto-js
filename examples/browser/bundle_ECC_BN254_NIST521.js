...
var EGS = ctx2.ECDH.EGS;
var EFS = ctx2.ECDH.EFS;
var EAS = 16;
var sha = ctx2.ECDH.HASH_TYPE;
...
// private key S0 of size EGS bytes derived from Password and Salt 
var S0 = ctx2.ECDH.PBKDF2(sha, PW, SALT, 1000, EGS);
