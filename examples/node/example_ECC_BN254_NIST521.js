...
var PW = ctx1.Utils.stringtobytes(pp);
// private key S0 of size EGS bytes derived from Password and Salt
var S0 = ctx1.ECDH.PBKDF2(ctx1.ECDH.HASH_TYPE, PW, SALT, 1000, ctx1.ECDH.EGS);

console.log("Alice's private key= 0x" + ctx1.Utils.bytestohex(S0));
// Generate Key pair S/W
ctx1.ECDH.KEY_PAIR_GENERATE(null, S0, W0);

//console.log("Alice's public key= 0x" + ctx1.Utils.bytestohex(W0));
...
console.log("Servers private key= 0x" + ctx1.Utils.bytestohex(S1));
//console.log("Servers public key= 0x" + ctx1.Utils.bytestohex(W1));
...
console.log("Alice's ECDH Key= 0x" + ctx1.Utils.bytestohex(KEY));
console.log("Servers ECDH Key= 0x" + ctx1.Utils.bytestohex(KEY));
...
var PW = ctx2.Utils.stringtobytes(pp);
// private key S0 of size EGS bytes derived from Password and Salt
var S0 = ctx2.ECDH.PBKDF2(ctx2.ECDH.HASH_TYPE, PW, SALT, 1000, ctx1.ECDH.EGS);

console.log("Alice's private key= 0x" + ctx2.Utils.bytestohex(S0));
// Generate Key pair S/W
ctx2.ECDH.KEY_PAIR_GENERATE(null, S0, W0);

//console.log("Alice's public key= 0x" + ctx2.Utils.bytestohex(W0));
...
console.log("Servers private key= 0x" + ctx2.Utils.bytestohex(S1));
//console.log("Servers public key= 0x" + ctx2.Utils.bytestohex(W1));
...
console.log("Alice's ECDH Key= 0x" + ctx2.Utils.bytestohex(KEY));
console.log("Servers ECDH Key= 0x" + ctx2.Utils.bytestohex(KEY));
