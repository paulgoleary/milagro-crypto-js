...
console.log("Ciphertext= 0x" + ctx1.Utils.bytestohex(C));
...
console.log("Decoding= 0x" + ctx1.Utils.bytestohex(MS));

console.log("message= " + ctx1.Utils.bytestostring(MS));
...
console.log("Signature= 0x" + ctx1.Utils.bytestohex(S));
...
console.log("C= 0x" + ctx2.Utils.bytestohex(CS));
console.log("D= 0x" + ctx2.Utils.bytestohex(DS));
