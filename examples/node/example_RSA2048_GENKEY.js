...
console.log("Ciphertext= 0x" + ctx.Utils.bytestohex(C));
...
console.log("Decoding= 0x" + ctx.Utils.bytestohex(MS));

console.log("message= " + ctx.Utils.bytestostring(MS));
...
console.log("Signature= 0x" + ctx.Utils.bytestohex(S));
