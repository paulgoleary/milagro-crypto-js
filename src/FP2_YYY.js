...
/* FP2_YYY elements are of the form a+ib, where i is sqrt(-1) */

/* general purpose constructor */
var FP2_YYY = function(c, d) {
    if (c instanceof FP2_YYY) {
        this.a = new FP_YYY(c.a);
        this.b = new FP_YYY(c.b);
    } else {
        this.a = new FP_YYY(c);
        this.b = new FP_YYY(d);
    }
...
FP2_YYY.prototype = {
    ...
    /* set from two BIG_XXXs */
    bset: function(c, d) {
        this.a.bcopy(c);
        this.b.bcopy(d);
    },

    /* set from one BIG_XXX */
    bseta: function(c) {
        this.a.bcopy(c);
        this.b.zero();
    },
    ...
    /* this-=x */
    sub: function(x) {
        var m = new FP2_YYY(x); //var m=new FP2_YYY(0); m.copy(x);
        m.neg();
        this.add(m);
    },
    ...
    sqrt: function() {
        ...
        var w1 = new FP_YYY(this.b);
        var w2 = new FP_YYY(this.a);
    ...
    pow: function(e) {
        ...
        var r = new FP2_YYY(1);
        this.norm();
        var x = new FP2_YYY(this); //x.copy(this);
        e.norm();
        while (true) {
            bt = e.parity();
            e.fshr(1);
