...
/* FP4_YYY elements are of the form a+ib, where i is sqrt(-1+sqrt(-1))  */

/* general purpose constructor */
var FP4_YYY = function(c, d) {
    if (c instanceof FP4_YYY) {
        this.a = new FP2_YYY(c.a);
        this.b = new FP2_YYY(c.b);
    } else {
        this.a = new FP2_YYY(c);
        this.b = new FP2_YYY(d);
    }
};
...
FP4_YYY.prototype = {
    ...
    /* this=-this */
    neg: function() {
        var m = new FP2_YYY(this.a); //m.copy(this.a);
        var t = new FP2_YYY(0);
        m.add(this.b);
        m.neg();
        //	m.norm();
    ...
    mul: function(y) {
        ...
        var t1 = new FP2_YYY(this.a); //t1.copy(this.a);
        var t2 = new FP2_YYY(this.b); //t2.copy(this.b);
        var t3 = new FP2_YYY(0);
        var t4 = new FP2_YYY(this.b); //t4.copy(this.b);
    ...
    times_i: function() {
        var s = new FP2_YYY(this.b); //s.copy(this.b);
        var t = new FP2_YYY(this.b); //t.copy(this.b);
        s.times_i();
        t.add(s);
        this.b.copy(this.a);
        this.a.copy(t);
    ...
    xtr_pow2: function(ck, ckml, ckm2l, a, b) {
        a.norm();
        b.norm();
        var e = new BIG_XXX(a); //e.copy(a);
        var d = new BIG_XXX(b); //d.copy(b);
        var w = new BIG_XXX(0);

        var cu = new FP4_YYY(ck); //cu.copy(ck); // can probably be passed in w/o copying
        var cv = new FP4_YYY(this); //cv.copy(this);
        var cumv = new FP4_YYY(ckml); //cumv.copy(ckml);
        var cum2v = new FP4_YYY(ckm2l); //cum2v.copy(ckm2l);
        var r = new FP4_YYY(0);
        var t = new FP4_YYY(0);
