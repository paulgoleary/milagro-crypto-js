...
ECP2_ZZZ.prototype = {
    ...
    equals: function(Q) {
        ...
        var zs2 = new FP2_YYY(this.z); /*zs2.copy(this.z);*/
        zs2.sqr();
        var zo2 = new FP2_YYY(Q.z); /*zo2.copy(Q.z);*/
        zo2.sqr();
        var zs3 = new FP2_YYY(zs2); /*zs3.copy(zs2);*/
        zs3.mul(this.z);
        var zo3 = new FP2_YYY(zo2); /*zo3.copy(zo2);*/
        zo3.mul(Q.z);
        zs2.mul(Q.x);
        zo2.mul(this.x);
