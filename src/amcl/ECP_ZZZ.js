...
ECP_ZZZ.prototype = {
    ...
    equals: function(Q) {
        ...
        if (ECP_ZZZ.CURVETYPE == ECP_ZZZ.WEIERSTRASS) {
            var zs2 = new FP_YYY(0);
            zs2.copy(this.z);
            zs2.sqr();
            var zo2 = new FP_YYY(0);
            zo2.copy(Q.z);
            zo2.sqr();
            var zs3 = new FP_YYY(0);
            zs3.copy(zs2);
            zs3.mul(this.z);
            var zo3 = new FP_YYY(0);
            zo3.copy(zo2);
            zo3.mul(Q.z);
            zs2.mul(Q.x);
            zo2.mul(this.x);
    ...
    dbl: function() {
        ...
        if (ECP_ZZZ.CURVETYPE == ECP_ZZZ.MONTGOMERY) {
            ...
            A.copy(C);
            A.imul((ROM_CURVE_ZZZ.CURVE_A + 2) >> 2);
    ...
    mul: function(e) {
        ...
        var P = new ECP_ZZZ();
        if (ECP_ZZZ.CURVETYPE == ECP_ZZZ.MONTGOMERY) { /* use ladder */
            var nb, i, b;
            var D = new ECP_ZZZ();
            var R0 = new ECP_ZZZ();
            R0.copy(this);
...
ECP_ZZZ.RHS = function(x) {
    ...
    if (ECP_ZZZ.CURVETYPE == ECP_ZZZ.WEIERSTRASS) { // x^3+Ax+B
        var b = new FP_YYY(0);
        b.rcopy(ROM_CURVE_ZZZ.CURVE_B);
        r.mul(x);
        if (ROM_CURVE_ZZZ.CURVE_A == -3) {
    ...
    if (ECP_ZZZ.CURVETYPE == ECP_ZZZ.EDWARDS) { // (Ax^2-1)/(Bx^2-1) 
        var b = new FP_YYY(0);
        b.rcopy(ROM_CURVE_ZZZ.CURVE_B);
    ...
    if (ECP_ZZZ.CURVETYPE == ECP_ZZZ.MONTGOMERY) { // x^3+Ax^2+x
        var x3 = new FP_YYY(0);
        x3.copy(r);
        x3.mul(x);
