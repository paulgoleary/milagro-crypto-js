...
/* Initialise Hash function */
	...
	{ /* initialise */
		...
		this.length[0]=new ctx.UInt64(0,0); this.length[1]=new ctx.UInt64(0,0);
...
/* process a single byte */
	...
	{ /* process the next message byte */
		...
		this.length[0].add(e);
		if (this.length[0].top===0 && this.length[0].bot==0) { e=new ctx.UInt64(0,1); this.length[1].add(e); }
...
HASH384.HK = [new ctx.UInt64(0x428a2f98, 0xd728ae22), new ctx.UInt64(0x71374491, 0x23ef65cd),
      ...
      new ctx.UInt64(0x5fcb6fab, 0x3ad6faec), new ctx.UInt64(0x6c44198c, 0x4a475817)];return HASH384;
};
