...
/* ctx.NewHope API high-level functions  */
...
/* Cooley-Tukey NTT */
	...
	ntt: function(x)
	{
		var m,i,j,k,t=NHS.DEGREE/2;
		var S,U,V,W,q=NHS.PRIME;
...
/* convert 32-byte seed to random polynomial */
	...
	Parse: function(seed,poly)
	{
		...
		var n;
		var hash=[];
		var sh=new ctx.SHA3(SHA3.SHAKE128);
...
/* 7 bytes is 3x14 */
	...
	unpack: function(array,poly)
	{
		...
		for (i=j=0;i<NHS.DEGREE; )
		{
			a=array[j++]&0xff; b=array[j++]&0xff; c=array[j++]&0xff; d=array[j++]&0xff; e=array[j++]&0xff; f=array[j++]&0xff; g=array[j++]&0xff;
			poly[i++]=a|((b&0x3f)<<8);
...
/* API files */
	...
	SERVER_1: function (RNG,SB,S)
	{
		...
		var array=new Uint8Array(1792);

		var s=new Int32Array(NHS.DEGREE);
		var e=new Int32Array(NHS.DEGREE);
		var b=new Int32Array(NHS.DEGREE);
	...
	{
		var i;
		var sh=new ctx.SHA3(SHA3.ctx.HASH256);

		var seed=new Uint8Array(32);
		var array=new Uint8Array(1792);
		var key=new Uint8Array(32);
		var cc=new Uint8Array(384);

		var sd=new Int32Array(NHS.DEGREE);
		var ed=new Int32Array(NHS.DEGREE);
		var u=new Int32Array(NHS.DEGREE);
		var k=new Int32Array(NHS.DEGREE);
		var c=new Int32Array(NHS.DEGREE);
