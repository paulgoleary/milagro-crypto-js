...
eval(fs.readFileSync('BIG_256.js')+'');
eval(fs.readFileSync('DBIG_256.js')+'');
eval(fs.readFileSync('ROM_CURVE_ZZZ.js')+'');
eval(fs.readFileSync('ROM_FIELD_YYY.js')+'');
eval(fs.readFileSync('UInt64.js')+'');
eval(fs.readFileSync('RAND.js')+'');
eval(fs.readFileSync('FP_YYY.js')+'');
eval(fs.readFileSync('HASH256.js')+'');
eval(fs.readFileSync('HASH512.js')+'');
eval(fs.readFileSync('ECP_ZZZ.js')+'');
eval(fs.readFileSync('ECDH_ZZZ.js')+'');
