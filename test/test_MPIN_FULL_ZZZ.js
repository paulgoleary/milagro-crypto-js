...
/* Client gets "Time Token" permit from DTA */ 	
	...
	console.log("Time Permit TP: 0x"+MPIN_ZZZ.bytestostring(PERMIT));   

/* This encoding makes Time permit look random - Elligator squared */
	MPIN_ZZZ.ENCODING(rng,PERMIT);
	console.log("Encoded Time Permit TP: 0x"+MPIN_ZZZ.bytestostring(PERMIT));   
	MPIN_ZZZ.DECODING(PERMIT);
	console.log("Decoded Time Permit TP: 0x"+MPIN_ZZZ.bytestostring(PERMIT));   
}
else date=0;
